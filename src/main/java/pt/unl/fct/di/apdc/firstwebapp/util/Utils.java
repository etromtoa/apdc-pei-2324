...
public class Utils {
	...
	public static final String WRONG_LENGTH_USERNAME = "Username must be between " + USERNAME_MIN_LENGTH + " and "
	...
	public static final String WRONG_LENGTH_PASSWORD = "Password must be between " + PASSWORD_MIN_LENGTH + " and "
	...
	public static final String EMAIL_LONG_LOCAL = "The local part of the email address is too long. Max lengh = 64.";
	public static final String EMAIL_LONG_DOMAIN = "The domain part of the email address is too long. Max lengh = 255.";
	public static final String EMAIL_LONG_LABEL = "One or more labels in the domain part of the email address is too long. Max lengh = 63 each.";

	// ERROR MESSAGES NAME

	public static final String WRONG_LENGTH_NAME = "Name must be between " + NAME_MIN_LENGTH + " and " + NAME_MAX_LENGTH
			+ " characters long.";
	...
	public static String isEmailValid(String mail) {
		...
		if (domains[0].length() > 64) {
			return EMAIL_LONG_LOCAL;
		}
		if (domains[1].length() > 255) {
